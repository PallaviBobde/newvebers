...
export const services = [
  {
    ...
    description:
      "Elevate your brand with our responsive website designs tailored to your identity.",
    icon: "💻",
  },
  {
    name: "Logo Design",
    description:
      "Unleash the power of a memorable logo that speaks volumes about your business.",
    icon: "🎨",
  },
  {
    name: "Instapost Making",
    description:
      "Boost your social media presence with our eye-catching Instagram posts.",
    icon: "📸",
  },
  {
    name: "Digital Marketing",
    description:
      "Drive online success with our strategic digital marketing campaigns.",
    icon: "🚀",
  },
  {
    name: "E-commerce Solutions",
    description:
      "Simplify online transactions with our secure and user-friendly e-commerce solutions.",
    icon: "🛒",
  },
  {
    name: "Mobile App Development",
    description:
      "Experience seamless digital interaction through our custom mobile app development.",
    icon: "📱",
  },
];
...
export const phoneNumber = '+918319699485';